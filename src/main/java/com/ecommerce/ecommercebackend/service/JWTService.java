...
public class JWTService {
    ...
    private static final String VERIFICATION_EMAIL_KEY = "VERIFICATION_EMAIL_KEY";
    private static final String RESET_PASSWORD_EMAIL_KEY = "RESET_PASSWORD_EMAIL_KEY";
